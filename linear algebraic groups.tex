...
Conversely, from a finitely-generated abelian group $M$ one can construct the Hopf algebra $\mbb{F}\brs{M}$ with $\mbb{F}\prs{M} \cong \mbb{F}\brs{G}$ for a diagonalizable group $G$. Then $M = X^*\prs{G}$.
