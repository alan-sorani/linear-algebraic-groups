...
\begin{exercise}
Every subspace $X \subseteq \mbb{F}^n$ is quasi-compact.
\end{exercise}
...
A topological space $X$ is \emph{irreducible} if there aren't strict subsets $X_1, X_2 \subsetneq X$ such that $X = X_1 \cup X_2$.
\end{definition}
