...
\varphi\prs{\theta} = \pmat{\cos \theta & \sin \theta  & 0 & 0 \\ -\sin \theta & \cos \theta & 0 & 0 \\ 0 & 0 & \cos\prs{\alpha \theta} & \sin\prs{\alpha \theta} \\ 0 & 0 & -\sin\prs{\alpha \theta} & \cos\prs{\alpha \theta}} \text{.}
\end{align*}
